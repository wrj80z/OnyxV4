...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('onyx/assets/new/blur.png')
...
local hash = loadstring(downloadFile('onyx/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('onyx/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('onyx/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
	tagcallback = {},
...
run(function()
	...
	function whitelist:announce(text)
		...
		icon.Image = getcustomasset('onyx/assets/new/vape.png')
	...
	function whitelist:update(first)
		local suc = pcall(function()
			local _, subbed = pcall(function()
				return game:HttpGet('https://github.com/wrj80z/whitelists')
			end)
			local commit = subbed:find('currentOid')
			commit = commit and subbed:sub(commit + 13, commit + 52) or nil
			commit = commit and #commit == 40 and commit or 'main'
			whitelist.textdata = game:HttpGet('https://raw.githubusercontent.com/wrj80z/whitelists/'..commit..'/PlayerWhitelist.json', true)
		end)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('onyx/profiles/whitelist.json') and readfile('onyx/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('onyx/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('onyx/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('onyx/assets/new/radaricon.png'),
